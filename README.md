...
x [Update Your Resume](#update-your-resume)
x [Find a Job](#find-a-job)
...
x [Additional Learning](#additional-learning)
    ...
    x [Information theory](#information-theory-videos)
    x [Parity & Hamming Code](#parity--hamming-code-videos)
    x [Entropy](#entropy)
    ...
    x [Treap](#treap)
    x [Linear Programming](#linear-programming-videos)
    x [Geometry, Convex hull](#geometry-convex-hull-videos)
