...
## Preparation for Full Stack Web Development

- Study basics of

1.  HTML - Basic Building Block of the Website or Web Application
2.  CSS - Styling the Web Applicaiton or Website
3.  JavaScript - Giving Functionality to the components you have created using HTML.

- Learn Few Frameworks of CSS
...
- Under JavaScript we have:

1.  ES6
2.  TypeScript
3.  Package Manager Such as NPM and YPM
4.  JS Framework
5.  JS Libraries - most important concepts

- Under JS Framework we have:

1.  Angular JS
2.  Vue JS
3.  Nuxt JS

- Major JS Libraries include:

1.  JQuery
2.  React JS
3.  P5.js
    These are the major steps and concept for becoming a Full Stack Web Developer.
