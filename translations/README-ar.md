...
- [المزيد من المعرفة](#more-knowledge)
...
- [Graphs](#graphs)
  ...
  - adjacency list
  - traversals: BFS, DFS
- [المزيد من المعرفة حتى](#even-more-knowledge)
  - [تكراري](#recursion)
  - [البرمجة الديناميكية](#dynamic-programming)
  - [البرمجة الشيئية](#object-oriented-programming)
  - [أنماط التصميم](#design-patterns)
  - [التوافقية (ن اختر ك) والاحتمالية](#combinatorics-n-choose-k--probability)
  ...
  - [الشبكات](#networking)
- [تصميم النظام وقابلية التوسع ومعالجة البيانات](#system-design-scalability-data-handling) (إذا كان لديك خبرة 4+ سنوات)
- [مراجعة نهائية](#final-review)
- [Coding Question Practice](#coding-question-practice)
- [تمارين برمجية/ تحديات](#coding-exerciseschallenges)
- [بمجرد أن تكون قريبا من المقابلة](#once-youre-closer-to-the-interview)
- [سيرتك الذاتية](#your-resume)
- [فكر في موعد المقابلة](#be-thinking-of-for-when-the-interview-comes)
- [لديك أسئلة للمحاور](#have-questions-for-the-interviewer)
- [بمجرد حصولك على الوظيفة](#once-youve-got-the-job)

---------------- كل شيء أسفل هذه النقطة اختياري ----------------

## مصادر إضافية

- [كتب إضافية](#additional-books)
- [التعلم الإضافي](#additional-learning)
  - [Compilers](#compilers)
...
[Github-flavored markdown المزيد حول](https://guides.github.com/features/mastering-markdown/#GitHub-flavored-markdown)
...
- [من الخطير أن تذهب بمفردك: محاربة الوحوش الغير المرئية في عالم التكنولوجيا](https://www.youtube.com/watch?v=1i8ylq4j_EY)
...
- [ ] [كيفية اجتياز المقابلة الهندسية عام 2021](https://davidbyttow.medium.com/how-to-pass-the-engineering-interview-in-2021-45f1b389a1)
- [ ] [Whiteboarding](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1)
- [ ] [تبسيط التوظيف الفني](https://www.youtube.com/watch?v=N233T0epWTs)
- [ ] كيف تحصل على وظيفة في الكبار 4:
  - [ ] [كيف تحصل على وظيفة في الكبار 4 - أمازون ،فيسبوك،جوجل ومايكروسوفت (فيديو)](https://www.youtube.com/watch?v=YJZCUhxNCv8)
...
- [اختر لغة البرمجة المناسبة للمقابلة](http://www.byte-by-byte.com/choose-the-right-language-for-your-coding-interview/)
- http://blog.codingforinterviews.com/best-programming-language-jobs/

[شاهد مصادر اللغات من هنا](programming-language-resources.md)

سترى بعض سي و سي++ و بايثون مضمنًا أدناه ، لأنني أتعلم. هناك عدد قليل من الكتب المعنية ، انظر الجزء السفلي.
...
- ### Linked Lists
  ...
  - [ ] Description:
    ...
    - [ ] [CS 61B - Linked Lists 2 (video)](https://archive.org/details/ucberkeley*webcast*-c4I3gFYe3w)
...
- [Algorithm Design Manual](http://www.amazon.com/Algorithm-Design-Manual-Steven-Skiena/dp/1849967202) (Skiena)
  ...
  - Answers:
    - [Solutions](<http://www.algorithm.cs.sunysb.edu/algowiki/index.php/The*Algorithms_Design_Manual*(Second_Edition)>)
...
- [UC Berkeley 61C: Machine Structures (26 videos)](https://archive.org/details/ucberkeley-webcast-PL-XXv-cvA*iCl2-D-FS5mk0jFF6cYSJs*)
