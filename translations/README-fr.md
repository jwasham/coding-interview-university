...
- [ ] Notes :
    - Implémenter des tris et connaître le meilleur et le pire des cas, la complexité moyenne de chacun :
        - pas de bubble sort - c'est terrible - O(n^2), sauf quand n <= 16
    - [ ] stabilité des algorithmes de tri ("Est-ce que Quicksort est stable ?")
        - [Stabilité des algorithmes de tri](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability)
        - [Stabilité dans les algorithmes de tri](http://stackoverflow.com/questions/1517793/stability-in-sorting-algorithms)
        - Stabilité dans les algorithmes de tri](http://www.geeksforgeeks.org/stability-in-sorting-algorithms/)
        - [Algorithmes de tri - Stabilité](http://homepages.math.uic.edu/~leon/cs-mcs401-s08/handouts/stability.pdf)
    - [ ] Quels algorithmes peuvent être utilisés sur des listes chaînées ? Lesquels sur les tableaux ? Lesquels sur les deux ?
        - Je ne recommanderais pas de trier une liste chaînée, mais le tri par fusion est faisable.
        - [Merge Sort For Linked List](http://www.geeksforgeeks.org/merge-sort-for-linked-list/)

- Pour le heapsort, voir la structure de données Heap ci-dessus. Le tri par tas est génial, mais pas stable.

- [ ] [Sedgewick - Mergesort (5 vidéos)](https://www.youtube.com/watch?v=4nKwesx_c8E&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9)
    - [ ] [1. tri par fusion](https://www.youtube.com/watch?v=4nKwesx_c8E&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9&index=1)
    - [ ] [2. tri par fusion de bas en haut](https://www.youtube.com/watch?v=HGOIGUYjeyk&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9&index=2)
    - [ ] [3. complexité du tri](https://www.youtube.com/watch?v=WvU_mIWo0Ac&index=3&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9)
    - [ ] [4. comparateurs](https://www.youtube.com/watch?v=7MvC1kmBza0&index=4&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9)
    - [ ] [5. stabilité](https://www.youtube.com/watch?v=XD_5iINB5GI&index=5&list=PLe-ggMe31CTeunC6GZHFBmQx7EKtjbGf9)

- [ ] [Sedgewick - Quicksort (4 vidéos)](https://www.youtube.com/playlist?list=PLe-ggMe31CTeE3x2-nF1-toca1QpuXwE1)
    - [ ] [1. tri rapide](https://www.youtube.com/watch?v=5M5A7qPWk84&index=1&list=PLe-ggMe31CTeE3x2-nF1-toca1QpuXwE1)
    - [ ] [2. sélection](https://www.youtube.com/watch?v=CgVYfSyct_M&index=2&list=PLe-ggMe31CTeE3x2-nF1-toca1QpuXwE1)
    - [ ] [3. clés en double](https://www.youtube.com/watch?v=WBFzOYJ5ybM&index=3&list=PLe-ggMe31CTeE3x2-nF1-toca1QpuXwE1)
    - [ ] [4. tri par système](https://www.youtube.com/watch?v=rejpZ2htBjE&index=4&list=PLe-ggMe31CTeE3x2-nF1-toca1QpuXwE1)

- [ ] UC Berkeley :
    - [ ] [CS 61B Lecture 29 : Triage I (vidéo)](https://www.youtube.com/watch?v=EiUvYS2DT6I&list=PL4BBB74C7D2A1049C&index=29)
    - [ ] [CS 61B Lecture 30 : Triage II (vidéo)](https://www.youtube.com/watch?v=2hTY3t80Qsk&list=PL4BBB74C7D2A1049C&index=30)
    - [ ] [CS 61B Lecture 32 : Triage III (vidéo)](https://www.youtube.com/watch?v=Y6LOLpxg6Dc&index=32&list=PL4BBB74C7D2A1049C)
    - [ ] [CS 61B Lecture 33 : Tri V (vidéo)](https://www.youtube.com/watch?v=qNMQ4ly43p4&index=33&list=PL4BBB74C7D2A1049C)

- [ ] [Tri à bulles (vidéo)](https://www.youtube.com/watch?v=P00xJgWzz2c&index=1&list=PL89B61F78B552C1AB)
- [ ] [Analyse du tri à bulles (vidéo)](https://www.youtube.com/watch?v=ni_zk257Nqo&index=7&list=PL89B61F78B552C1AB)
- [ ] [Tri par insertion, tri par fusion (vidéo)](https://www.youtube.com/watch?v=Kg4bqzAqRBM&index=3&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
- [ ] [Tri par insertion (vidéo)](https://www.youtube.com/watch?v=c4BRHC7kTaQ&index=2&list=PL89B61F78B552C1AB)
- [ ] [Tri par fusion (vidéo)](https://www.youtube.com/watch?v=GCae1WNvnZM&index=3&list=PL89B61F78B552C1AB)
- [ ] [Tri rapide (vidéo)](https://www.youtube.com/watch?v=y_G9BkAm6B8&index=4&list=PL89B61F78B552C1AB)
- [ ] [Tri par sélection (vidéo)](https://www.youtube.com/watch?v=6nDMgr0-Yyo&index=8&list=PL89B61F78B552C1AB)

- [ ] Code de tri par fusion :
    - [ ] [Utilisation d'un tableau de sortie (C)](http://www.cs.yale.edu/homes/aspnes/classes/223/examples/sorting/mergesort.c)
    - [ ] [Utilisation d'un tableau de sortie (Python)](https://github.com/jwasham/practice-python/blob/master/merge_sort/merge_sort.py)
    - [ ] [En place (C++)](https://github.com/jwasham/practice-cpp/blob/master/merge_sort/merge_sort.cc)
- [ ] Code de tri rapide :
    - [ ] [Implémentation (C)](http://www.cs.yale.edu/homes/aspnes/classes/223/examples/randomization/quick.c)
    - [ ] [Implémentation (C)](https://github.com/jwasham/practice-c/blob/master/quick_sort/quick_sort.c)
    - [ ] [Implémentation (Python)](https://github.com/jwasham/practice-python/blob/master/quick_sort/quick_sort.py)

- [ ] Implémentation :
    - [ ] Tri par fusion : O(n log n) moyenne et pire cas
    - [ ] Tri rapide O(n log n) cas moyen
    - Le tri par sélection et le tri par insertion sont tous deux O(n^2) en moyenne et dans le pire des cas.
    - Pour heapsort, voir la structure de données Heap ci-dessus.

- [ ] Non requis, mais je les ai recommandés :
    - [ ] [Sedgewick - Radix Sorts (6 vidéos)](https://www.youtube.com/playlist?list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53)
        - [ ] [1. Chaînes de caractères en Java](https://www.youtube.com/watch?v=zRzU-FWsjNU&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53&index=6)
        - [ ] [2. comptage indexé par clé](https://www.youtube.com/watch?v=CtgKYmXs62w&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53&index=5)
        - [ ] [3. tri Radix du premier chiffre le moins significatif d'une chaîne de caractères](https://www.youtube.com/watch?v=2pGVq_BwPKs&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53&index=4)
        - [ ] [4. premier chiffre significatif de la première chaîne de caractères tri Radix](https://www.youtube.com/watch?v=M3cYNY90R6c&index=3&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53)
        - [ ] [5. 3 Way Radix Quicksort](https://www.youtube.com/watch?v=YVl58kfE6i8&index=2&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53)
        - [ ] [6. tableaux de suffixes](https://www.youtube.com/watch?v=HKPrVm5FWvg&list=PLe-ggMe31CTcNvUX9E3tQeM6ntrdR8e53&index=1)
    - [ ] [Tri par radicaux](http://www.cs.yale.edu/homes/aspnes/classes/223/notes.html#radixSort)
    - [ ] [Tri par radicaux (vidéo)](https://www.youtube.com/watch?v=xhr26ia4k38)
    - [ ] [Tri par radix, tri par comptage (temps linéaire avec contraintes) (vidéo)](https://www.youtube.com/watch?v=Nz1KZXbghj8&index=7&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
    - [ ] [Randomisation : Multiplication de matrices, Quicksort, algorithme de Freivalds (vidéo)](https://www.youtube.com/watch?v=cNB2lADK3_s&index=8&list=PLUl4u3cNGP6317WaSNfmCvGym2ucw3oGp)
    - [ ] [Triage en temps linéaire (vidéo)](https://www.youtube.com/watch?v=pOKy3RZbSws&list=PLUl4u3cNGP61hsJNdULdudlRL493b-XZf&index=14)

Si vous avez besoin de plus de détails sur ce sujet, voir la section "Tri" dans [Additional Detail on Some Subjects](#additional-detail-on-some-subjects)
