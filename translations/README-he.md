...
לאחר סיום תוכנית הלימודים הזאת, [התקבלתי לעבוד כמפתח תוכנה באמזון!](https://startupnextdoor.com/ive-been-acquired-by-amazon/?src=ciu) את\אתה כנראה לא תצטרכו ללמוד באותה כמות שאני למדתי. בכל אופן כל מה שאתם זקוקים לו נמצא פה.

למדתי בין 8-12 שעות ביום, למשך מספר חודשים. זהו הסיפור שלי:
[מה למדתי במשרה מלאה למשך שמונה חודשים בשביל ראיון עבודה בגוגל.](https://medium.freecodecamp.org/why-i-studied-full-time-for-8-months-for-a-google-interview-cc662ce9bb13)
...
זוהי תוכנית הלימוד הרב-חודשית שלי להיות מהנדס תוכנה בחברה גדולה.

**דרישות קדם:**
* מעט נסיון עם תיכנות (משתנים, לולאות, שיטות/פונקציות וכו)
* סבלנות
* זמן

אנא שימו לב שזוהי תוכנית לימוד ל**הנדסת תוכנה**, לא פיתוח ווב. חברות תוכנה גדולות כגון גוגל, אמזון פייסבוק ומייקרוסופט רואות הנדסת תוכנה כדבר שונה מפיתוח ווב. למשל, לאמזון יש מהנדסי צד לקוח (FEE) כמו גם מהנדסי פיתוח תוכנה (SDE). אלו הם שני תפקידים נפרדים ומאחר ולכל אחד מהם ישנם כישורים ודרישות משלו הראיונות אליהם לא יהיו אותו הדבר. חברות אלו דורשות ידע במדעי המחשב לתפקידי פיתוח/הנדסת תוכנה.
...
## תוכנית הלימודים
- [על מה מדובר כאן?](#על-מה-מדובר-כאן)
