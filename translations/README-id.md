...
- ### Arrays
	- Implemen sebuah vektor pengubah ukuran otomatis
    - [ ] Deskripsi:
        ...
        - [Mengubah ukuran array (video)](https://www.lynda.com/Developer-Programming-Foundations-tutorials/Resizable-arrays/149042/177108-4.html)
    - [ ] Implemen sebuah vektor (mutable array dengan pengubah ukuran otomatis):
		- [ ] Melatih pemrograman menggunakan array dan pointer, dan matematika pointer untuk melakukan loncatan pada sebuah index daripada menggunakan indexing.
		- [ ] data array mentah yang baru dengan memori alokasi
			- dapat alokasi int array, hanya tidak menggunakan fiturnya.
			- dimulai dari 16, atau jika angka awal terlalu besar, gunakan kelipatan 2 - 16, 32, 64, 128
        - [ ] size() - ukuran dari array
        - [ ] capacity() - jumlah item yang dapat disimpan
        - [ ] is_empty()
        - [ ] at(index) - mengeluarkan hasil keluaran array pada index tersebut.
        - [ ] push(item)
        - [ ] insert(index, item) - memasukkan item ke index tersebut, shifts nilai dari index dan meletakkan elemen berikutnya ke kanan
        - [ ] prepend(item) - dapat menggunakan insert pada index 0
        - [ ] pop() - buang item dari paling belakang
        - [ ] delete(index) - menghapus item pada index, shifting elemen ke kiri
        - [ ] remove(item) - menghapus item berdasarkan value item
        - [ ] find(item) - mencari posisi index dari item, keluaran -1 jika tidak ketemu
        - [ ] resize(new_capacity) // private function
            - ketika sudah mencapai kapasitas, ubah ukuran menjadi 2x lipat
            - ketika membuang item, jika ukurannya 1/4 dari kapasitas, ubah ukuran menjadi 1/2 kapasitas
    - [ ] Kompleksitas waktu
        - O(1) to menambah/membuang dari belakang (amortized for allocations for more space), index, or update
        - O(n) to menambah/membuang dari mana pun
    - [ ] Space
