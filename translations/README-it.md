...
> All'inizio questa repository era una piccola lista di "cose da studiare" per diventare un ingegnere del
> software(Software Engineer), ma quella che vedete ora è qualcosa di più grande. Dopo aver seguito questo
> piano di studi [sono stato assunto come Software Development Engineer presso Amazon](https://startupnextdoor.com/ive-been-acquired-by-amazon/?src=ciu)!
>
> Gli oggetti elencati qui vi prepareranno molto bene per un'intervista in praticamente qualsiasi azienda che 
> produce software, inclusi i giganti del settore: Amazon, Facebook, Google o Microsoft.
>
> *Buona fortuna!*
...
Quando ho cominciato questo progetto, non sapevo distinguere uno stack da uno heap, non sapevo nulla a proposito della notazione O-grande, nulla degli alberi o come esplorare un grafo. Se dovevo codificare un algoritmo di ordinamento, posso dire che non sarebbe stato molto buono.
Ogni struttura dati che ho usato era già presente nel linguaggio (built-in), e non sapveo come funzionavano all'interno.
Non ho mai dovuto gestire la memoria a meno che un processo in esecuzione non mi segnalasse un errore di "out of memory", e quindi dovevo trovare un modo per aggirarlo. Ho usato pochi array multidimensionali in vita mia e migliaia di array associativi, ma non ho mai creato strutture dati partendo da zero.

È un piano luno. Può portarti via mesi. Se sei già familiare con molti di questi concetti ti richiederà molto meno tempo.

## Come usarlo

Tutto ciò che sta qua sotto è un esempio, e dovresti completare gli oggetti nell'ordine indicato dall'alto verso il basso.

Uso Markdown che è già integrato in GitHub, anche per gestire le liste degli obiettivi per controllare il progresso.

**Crea un nuovo branch così puoi tener traccia dei tuoi progressi. Basta inserire una x tra le parentesi: [x]**


    Esegui una fork di un branch e segui i comandi di seguito
...
`git fetch --all`
    ...
    Marca tutti i box con una X per denominare il compito come eseguito
...
- Gli Ingegneri del Software che hanno avuto successo sono intelligenti, ma molti hanno l'insicurezza di non esserlo abbastanza
- [The myth of the Genius Programmer](https://www.youtube.com/watch?v=0SARbwvhupQ)
- [It's Dangerous to Go Alone: Battling the Invisible Monsters in Tech](https://www.youtube.com/watch?v=1i8ylq4j_EY)

## Risorse video

Alcuni video sono disponibili solo iscrivendosi a Coursera, EdX, o Lynda.com. Questi sono chiamati MOOCs.
A volte i corsi non sono disponibili e quindi devi aspettare un paio di mesi, così non hai accesso. I corsi di Lynda.com non sono gratuiti.
...
- ### Ricorsione
    ...
    - meglio non usare la tail recursion?
        - [ ] [What Is Tail Recursion Why Is It So Bad?](https://www.quora.com/What-is-tail-recursion-Why-is-it-so-bad)
        - [ ] [Tail Recursion (video)](https://www.youtube.com/watch?v=L1jjXGfxozc)

- ### Programmazione dinamica
    - Questo argomento può essere abbastanza difficile, perché ogni problema risolvibile dalla programmazione dinamica deve essere definito cme una relazione di ricorsione, e trovarne una può essere complesso.
    - Consiglio di guardare molti esempi di programmazione dinamica fino a quando non ottieni una conoscenza solida del pattern coinvolto
    - [ ] Video:
        - i video di Skiena possono essere difficili da seguire dal momento che utilizza la lavagna, che è troppo piccola da vedere
...
- ### Programmazione orientata agli oggetti (OOP)
    ...
    - [ ] Object-Oriented Software Engineering: Software Dev Using UML and Java (21 videos):
        - Puoi saltare questa se conosci molto bene la OOP
...
- ### Calcolo combinatorio (n su k) & Probabilità
    ...
    - [ ] Khan Academy:
        ...
        - Solo i video - 41 (sono tutti semplici e corti):
            - [ ] [Probability Explained (video)](https://www.youtube.com/watch?v=uzkc-qNVoOk&list=PLC58778F28211FA19)

- ### NP, NP-Completezza and Algoritmi di approsimazione
    - Impara le più famose classi di problemi NP-completi: il commesso viaggiatore, lo zaino. Impara inoltre a riconoscerli quando te li mostrano ad un colloquio(di solito mascherati come altri problemi)
    - Sapere cosa signific NP-completo.
    ...
    - Pagine 1048 - 1140 di CLRS (se lo possiedi).
...
- ### Processi e Thread
    - [ ] Computer Science 162 - Operating Systems (25 videos):
        - per processi e thread guarda i video 1-11
        - [Operating Systems and System Programming (video)](https://www.youtube.com/playlist?list=PL-XXv-cvA_iBDyz-ba4yDskqMDY6A1w_c)
    - [What Is The Difference Between A Process And A Thread?](https://www.quora.com/What-is-the-difference-between-a-process-and-a-thread)
    - Copre:
        - Problemi di Processi, Thread, Concorrenza
            ...
            - deadlock
            - livelock
        - attività della CPU, interrupts, context switching
        - costrutti concorrenti moderni con processori multicore
        - [Paging, segmentation and virtual memory (video)](https://www.youtube.com/watch?v=LKe7xK0bF7o&list=PLCiOXwirraUCBE9i_ukL8_Kfg6XNv7Se8&index=2)
        - [Interrupts (video)](https://www.youtube.com/watch?v=uFKi2-J-6II&list=PLCiOXwirraUCBE9i_ukL8_Kfg6XNv7Se8&index=3)
        - [Scheduling (video)](https://www.youtube.com/watch?v=-Gu5mYdKbu4&index=4&list=PLCiOXwirraUCBE9i_ukL8_Kfg6XNv7Se8)
        - Risorse usate dai processi(memoria: code, static storage, stack, heap, descrittori dei file, i/o)
        - Risorse usate dai thread (condivide quelli dei processi(eccetto lo stack) con altri thread durante lo stesso processo ma ognuno ha il suo program counter, stack counter, registri e stack)
        - Fork di un processo è una vera copia in caso di scrittura fino a quanto il nuovo processo scrive nella memoria, poi fa una copia completa
        - Context switching
            - Come è inizializzato il context switching dal sistema operativo e dall'hardware sottostante
...
- ### Papers
    - Leggere tutto fino alla fine riuscendo a comprendere tutto ti porterà via più tempo di quello che hai a disposizione. Raccomando una selezione accurata dei paper e delle loro sezioni.
    - [Ami i paper classici](https://www.cs.cmu.edu/~crary/819-f09/)
...
- ### Testing
    - Da coprire:
        - come funziona lo unit testin
        - cosa sono gli oggetti mock
...
- ### Scheduling
    - in un SO, come funziona
    - can be gleaned from Operating System videos

- ### Implementa routine di sistema
    - comprendere cosa c'è dietro le API di programmazione che utilizzi
    - puoi implementarle?

- ### Ricerca e manipolazione di stringhe
    ...
    Se hai bisogno di maggiori dettagli sull'argomento, guarda la sezione "String Matching" in questo documento [Additional Detail on Some Subjects](#additional-detail-on-some-subjects)

- ### Ricerca
    - Nota che esistono varie tipologie di ricerca. Alcune hanno prefissi, altre no, e alcune usano stringhe al posto dei bit per tracciare un cammino.
    - Leggo il codice, ma non lo implemento.
...
- ### Numeri in virgola mobile
    - [ ] semplici 8-bit: [Representation of Floating Point Numbers - 1 (video - there is an error in calculations - see video description)](https://www.youtube.com/watch?v=ji3SfClm8TU)
...
- ### Networking
    - **se hai esperienza di networking oppure vuoi diventare un ingegnere di sistema(sistemista), aspettati domande su questo argomento**
    - altrimenti, questo è soltanto buono da conoscere
...
---
    ...
    *****************************************************************************************************
    ...
    Tutto al di sotto di questo punto è opzionale.
    Studiando i punti seguenti, avrai un'ulteriore esposizione a molti più concetti legati all'Informatica,
    e diventerai più preparato ad affrontare un lavoro da ingegnere del software. Sarai un ingegnere del
    software a tutto tondo.
...
- [ ] [Head First Design Patterns](https://www.amazon.com/gp/product/0596007124/)
    - un'introduzione semplice ai design pattern
- [ ] [Design Patterns: Elements of Reusable Object-Oriente​d Software](https://www.amazon.com/Design-Patterns-Elements-Reusable-Object-Oriented/dp/0201633612)
    - aka il libro della "Gang Of Four", o GOF
    - il libro canonico sui design pattern
- [ ] [UNIX and Linux System Administration Handbook, 4th Edition](https://www.amazon.com/UNIX-Linux-System-Administration-Handbook/dp/0131480057/)

## Apprendimento ulteriore

Questi argomenti normalmente non verranno fuori durante un colloquio, ma li aggiungo per aiutarti a ottenere
molte altre conoscenze per essere un buon ingegnere del software, in sostanza tecnologie e algoritmi che si
aggiungeranno ai tuoi strumenti.
...
- ### Emacs e vi(m)
    - Familiarizza con un editor unix-based
    - vi(m):
...
- ### Unix command line tools
    - Di seguito ho messo strumenti utilissimi.
    - [ ] bash
    - [ ] cat
    - [ ] grep
    - [ ] sed
...
- ### Teoria dell'informazione (video)
    - [ ] [Khan Academy](https://www.khanacademy.org/computing/computer-science/informationtheory)
    - [ ] di più a proposito dei processi di Markov:
        - [ ] [Core Markov Text Generation](https://www.coursera.org/learn/data-structures-optimizing-performance/lecture/waxgx/core-markov-text-generation)
        - [ ] [Core Implementing Markov Text Generation](https://www.coursera.org/learn/data-structures-optimizing-performance/lecture/gZhiC/core-implementing-markov-text-generation)
        - [ ] [Project = Markov Text Generation Walk Through](https://www.coursera.org/learn/data-structures-optimizing-performance/lecture/EUjrq/project-markov-text-generation-walk-through)

- ### Parità e Codice di Hamming (video)
    - [ ] [Intro](https://www.youtube.com/watch?v=q-3BctoUpHE)
    - [ ] [Parità](https://www.youtube.com/watch?v=DdMcAUlxh1M)
    - [ ] Codice di Hammign:
...
- ### Entropia
    - assiucrati di guardare per primi i video sulla teoria dell'informazione
...
- ### Messaging, Serialization, e Queueing Systems
...
- ### Bloom Filter
    - Dato un Bloom filter con m bit e k funzioni hash, inserimento e ottenimento di un valore sono O(k)
...
- ### Locality-Sensitive Hashing
    - usato per determinare la similarità tra documenti
    - l'opposto di  MD5 o SHA che sono usati per determinare se 2 documenti/stringhe sono esattamente gli stessi.
