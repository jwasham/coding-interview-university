...
> [나는 아마존에 소프트웨어 엔지니어로 채용됬다](https://startupnextdoor.com/ive-been-acquired-by-amazon/?src=ciu)!
> 를 보면 당신은 아마 내가 한 것처럼 많이 공부할 필요는 없을 것이다. 어쨋든 당신이 필요로 하는 모든 것은 여기에 있다.
>
