...
- [Üsttekileri öğrendikten sonra öğrenilmesi gerekenler](#even-more-knowledge)
    ...
    - [Nesne yönelimli programlama _(Object oriented programming)_](#object-oriented-programming)
    ...
    - [Bilgisayar bilimleri tarihinde yapılmış önemli çalışmalar](#papers)
    - [Yazılım testi _(Software Testing)_](#testing)
    - [İşletim sistemlerinde zamanlama _(OS Scheduling)_](#scheduling)
    - [Programlama arayüzü (API) geliştirme _(Implementing system routines)_](#implement-system-routines)
    - [Stringler üzerinde işlem yapma ve arama _(String searching & manipulations)_](#string-searching--manipulations)
- [Sistem tasarımı, ölçeklenebilirlik ve veri organizasyonu _(System Design, Scalability, Data Handling)_](#system-design-scalability-data-handling)
**_(Bu kısım için çeviri notunu okuyun)_**
...
---------------- Bu kısmdan sonrasını öğrenip-öğrenmemek sana kalmış ----------------

- [Okuman gereken ekstra kitaplar](#additional-books)
- [Ek olarak bilmen gerekenler](#additional-learning)
    - [Derleyiciler _(Compilers)_](#compilers)
    - [Bilgisayar noktalı sayıları nasıl işliyor ? _(Floating Point Numbers)_](#floating-point-numbers)
    - [Unicode](#unicode)
    - [Endianness](#endianness)
    - [Emacs and vi(m)](#emacs-and-vim)
    - [Komut satırında işini kolaylaştıracak araçlar _(Unix command line tools)_](#unix-command-line-tools)
    - [Bilgi teorisi _(Information theory)_](#information-theory)
    - [Parity & Hamming Code](#parity--hamming-code)
    - [Entropy](#entropy)
    - [Şifreleme _(Cryptography)_](#cryptography)
    - [Sıkıştırma algoritmaları _(Compression)_](#compression)
    - [İnternet ve bilgisayar ağları _(Networking)_](#networking) (if you have networking experience or want to be a systems engineer, expect questions)
    - [Bilgi güvenliği _(Computer Security)_](#computer-security)
    - [Çöp toplama (Otomatik bellek yönetimi) _(Garbage collection)_](#garbage-collection)
    - [Paralel programla _(Parallel Programming)_](#parallel-programming)
    - [Messaging, Serialization, and Queueing Systems](#messaging-serialization-and-queueing-systems)
    - [Fast Fourier Transform](#fast-fourier-transform)
    - [Bloom Filter](#bloom-filter)
    - [HyperLogLog](#hyperloglog)
    - [Locality-Sensitive Hashing](#locality-sensitive-hashing)
    - [van Emde Boas Ağaçları _(van Emde Boas Trees)_](#van-emde-boas-trees)
    - [Augmented Data Structures](#augmented-data-structures)
    - [Trie'ler _(Tries_)](#tries)
    - [N-ary (K-ary, M-ary) trees](#n-ary-k-ary-m-ary-trees)
    - [Dengelenmiş arama ağaçları _(Balanced search trees)_](#balanced-search-trees)
        - AVL trees
        - Splay trees
        - Red/black trees
        - 2-3 search trees
    ...
    - [Ayrık yapılar ile hesaplama (Ayrık matematik) _(Discrete math)_](#discrete-math)
    - [Makine öğrenmesi _(Machine Learning_)](#machine-learning)
    - [Go programlama dili _(Go programming language)_](#go)
- [Bazı konular için ek detaylar](#additional-detail-on-some-subjects)
- [Zorlandığın yerler için faydalı olabilecek videolar](#video-series)
- [Üniversitelerin verdiği online dersler](#computer-science-courses)
