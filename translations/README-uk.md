...
- [Coding Interview University](#coding-interview-university)
	...
	- [Про відеоресурси](#про-відеоресурси)
	- [Процес співбесіди та загальна підготовка до інтерв'ю](#процес-співбесіди-та-загальна-підготовка-до-інтервю)
...
- Успішні програмісти достатньо розумні, але богато хто відчуває невпевненість в собі через думки про брак інтелекту.
- [Міф про геніального програміста](https://www.youtube.com/watch?v=0SARbwvhupQ)
- [It's Dangerous to Go Alone: боротьба з невидимими техно-монстрами](https://www.youtube.com/watch?v=1i8ylq4j_EY)

## Про відеоресурси

Деякі відео доступні лише за попереднім записом на майданчиках: Coursera, EdX, чи Lynda.com. Вони називаються [MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course).
Іноді заняття не проводяться, так що вам доводиться почекати пару місяців, ви не не будете мати постійний доступ. Курси на Lynda не безкоштовні.

    Буду вдячний за вашу допомогу у додаванні безкоштовних та завжди доступних загальнодоступних джерел, наприклад, відео на YouTube, які супроводжують відео онлайн-курсу.
    Мені подобається користуватися університетськими лекціями.

## Процес співбесіди та загальна підготовка до інтерв'ю

- [ ] [АБВ: Програмуйте завжди](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4)
- [ ] [Праця біля дошки](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1)
- [ ] [Викривальний технічний рекрутинг](https://www.youtube.com/watch?v=N233T0epWTs)
- [ ] Зламай своє інтерв'ю частина №1:
  - [ ] [Gayle L McDowell - Злам інтерв'ю з програмування (video)](https://www.youtube.com/watch?v=rEJzOhC5ZtQ)
  - [ ] [Злам інтерв'ю с Author Gayle Laakmann McDowell (video)](https://www.youtube.com/watch?v=aClxtDcdpsQ)
- [ ] Як отримати роботу в великой четверке:

  - [ ] [Як отримати роботу в Big 4 - Amazon, Facebook, Google & Microsoft (video)](https://www.youtube.com/watch?v=YJZCUhxNCv8)

- [ ] Подготовительный курс:
  - [ ] [Інтерв'ю з інженером-програмістом по поличках (платний курс)](https://www.udemy.com/software-engineer-interview-unleashed):
    - Дізнайтеся, як підготуватися до співбесіди, у колишнього інтерв'юера Google.
  - [ ] [Python для структури даних, Алгоритми, та Співбесіди! (платний курс)](https://www.udemy.com/python-for-data-structures-algorithms-and-interviews/):
    - Курс підготовки до співбесіди, орієнтований на Python, який охоплює структури даних, алгоритми, макетні інтерв'ю та багато іншого.
