**Google Interview University — підбірка матеріалів для вивчення програмування і підготовки до інтерв'ю в великих технологічних компаніях, наприклад таких як Google**

> Спочатку, я створив це як короткий список навчальних тем, з якими
> потрібно ознайомитися, щоб стати інженером-програмістом, але згодом
> він перетворився в великий список, який ви бачите сьогодні. Після
> проходження цього навчального плану, я отримав роботу в якості
> інженера з розробки програмного забезпечення в Amazon! Вам, ймовірно,
> не доведеться вчитися так багато, як це робив я. У всякому разі, все,
> що потрібно для навчання, є в цьому списку. 
> 
> Пункти, які тут перелічені, добре підготують вас до інтерв'ю в, майже
> будь-якій, технологічній компанія, включаючи таких гігантів як Amazon,
> Facebook, Google або Microsoft.
> 
> Бажаю вам успіху!

Оригінал матеріалу англійською: [Coding Interview University](https://github.com/OlegKKK/coding-interview-university/blob/master/README.md)

## Що це?

Це мій багатомісячний навчальний план, для переходу від веб-розробника самоучки, без профільної технічної освіти в області Computer Science, до інженера-програміста в великій компанії.

![enter image description here](https://camo.githubusercontent.com/9e32acff11b04496eb14e09b198fcbb055c9ccf0/68747470733a2f2f646e67356c33717a7265616c362e636c6f756466726f6e742e6e65742f323031362f4175672f636f64696e675f626f6172645f736d616c6c2d313437303836363336393131382e6a7067)

Цей матеріал призначений для нових інженерів-програмістів або для тих хто хоче перейти від веб розробки до розробка програмного забезпечення (де потрібне знання комп'ютерних наук). Якщо у вас є багаторічний досвід розробки програмного забезпечення, варто очікувати важче інтерв'ю.

Якщо у вас є багато років досвіду в розробці ПЗ чи веб-розробці, зауважте, що великі технологічні компанії як Google, Amazon, Facebook і Microsoft сприймають інженерів-програмістів по іншому, ніж розробників ПЗ чи веб-розробників, від інженерів-програмістів вимагають знать в області комп'ютерних наук.

Якщо ви хочете бути системним інженером, потрібно вивчити більше з додаткового списку(мережі, безпека).
